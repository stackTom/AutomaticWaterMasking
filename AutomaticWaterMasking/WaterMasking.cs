...
namespace AutomaticWaterMasking
{
    public static class SafeCompare
    {
        ...
        public static bool SafeLessThan(double d1, double d2)
        {
            return (d1 - d2) < -EPSILON;
        }

        public static bool SafeGreaterThan(double d1, double d2)
        {
            return (d1 - d2) > EPSILON;
        }

        public static bool SafeEquals(double d1, double d2)
        {
    ...
    public class XYPair
    {
        ...
        private const int ROUND_TO_DIGITS = 7;
        ...
        {
            return Math.Round(this.Y, ROUND_TO_DIGITS).ToString() + ", " + Math.Round(this.X, ROUND_TO_DIGITS).ToString();
        }
